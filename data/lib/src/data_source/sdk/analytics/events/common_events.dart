import "package:data/src/data_source/sdk/analytics/analytics_parameters.dart";
...
class AssistantClickEvent extends AnalyticsEvent {
  AssistantClickEvent(String name)
      : super(name: "click_assistant", params: {AnalyticsParameters.assistantName: name});
}
...
class AdsProductsReceivedEvent extends AnalyticsEvent {
  AdsProductsReceivedEvent(
      {String? weeklyProductId, String? monthlyProductId, String? yearlyProductId})
      : super(
...
class OfferBannerClickEvent extends AnalyticsEvent {
  OfferBannerClickEvent({required bool withCountdown})
      : super(
            ...
            params: {AnalyticsParameters.withCountdown: withCountdown.toString()});
}
