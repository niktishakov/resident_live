...
ThemeData lightTheme = ThemeData(
  ...
  cardTheme: const CardTheme(color: Color(0xFFE5E5E5)),
  dialogTheme: const DialogTheme(backgroundColor: Color(0xFFE5E5E5), elevation: 0),
