...
import 'package:resident_live/data/activity_segment.model.dart';
...
class TimelineSlider extends StatefulWidget {
  ...
  final double height;
  final List<ActivitySegment> periods;
...
class _TimelineSliderState extends State<TimelineSlider> {
  ...
  bool comparePeriods(
      List<ActivitySegment> periods, List<ActivitySegment> other) {
          ...
          return Column(
            ...
            children: [
              ...
              PrimaryButton(
                ...
                onPressed: () {
                  print("Add Period >>>> $_startValue, $_endValue");
                  final result = widget
