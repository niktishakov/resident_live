...
class SubRenewFailed extends AnalyticsEvent {
  SubRenewFailed(String subName)
    : super(name: "sub_renew_failed", params: {AnalyticsParameters.subscriptionName: subName});
}

class SubRenewSuccess extends AnalyticsEvent {
  SubRenewSuccess(String subName)
    : super(name: "sub_renew_success", params: {AnalyticsParameters.subscriptionName: subName});
}
