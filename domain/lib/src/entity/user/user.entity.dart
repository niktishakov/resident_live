...
class UserEntity with _$UserEntity {
  ...
  Map<String, List<StayPeriodValueObject>> get countries =>
      stayPeriods.fold<Map<String, List<StayPeriodValueObject>>>(
        {},
        (acc, period) {
  ...
  int daysSpentIn(String countryCode) {
    ...
    return periods.fold(0, (sum, period) {
      ...
      final effectiveStart =
          period.startDate.isBefore(twelveMonthsAgo) ? twelveMonthsAgo : period.startDate;
  ...
  String currentCountryCode() {
    return stayPeriods.last.countryCode;
  }
}
