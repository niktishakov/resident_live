...
import "package:data/src/shared/constants.dart";
...
class ShareService {
  ...
  String _buildResidenceShareContent({
    ...
    return isResident
        ? getShareResidence(countryName, statusToggleAt, statusToggleIn)
        : getShareNonResidence(countryName, statusToggleAt, statusToggleIn);
  }
