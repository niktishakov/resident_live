...
import 'package:resident_live/presentation/widgets/add_periods/widgets/country_selector.dart';

import '../grabber.dart';
import '../rl.close_button.dart';
...
class ResidencyJourneyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        final state = context.watch<SharedStateCubit>().state;
        final otherResidences = state.user.countryResidences.values.toList();
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      CountrySelector(
                        countries:
                            otherResidences.map((e) => e.countryName).toList(),
